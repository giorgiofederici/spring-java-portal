				...
				<div class="col-12">
					<div class="row">
						<div class="col-12 col-md-6 offset-md-3">
							<div class="row">
								<div class="col-12">
									<h1><spring:message code="sjp.showcases.ocs.webflow.shipping.title" /></h1>	
								</div>
							</div>
											      
							<form:form modelAttribute="order.shippingDetail" method="POST">
						  		<div class="form-group">
						    		<label for="name"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.name" /> *</label>
						    		<form:input path="name" size="25" id="name" type="text" class="form-control" />
						    		<form:errors path="name" cssClass="text-danger" />
						  		</div>
						  		<div class="form-group">
						    		<label for="shippingDate"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.shippingDate" /> *</label>
						    		<form:input path="shippingDate" id="shippingDate" type="text" class="form-control" size="10" />
						    		<form:errors path="shippingDate" cssClass="text-danger" />
						  		</div>
						  		<div class="form-group">
						    		<label for="doorNumber"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.doorNumber" /> *</label>
						    		<form:input path="shippingAddress.doorNumber" size="25" id="doorNumber" type="text" class="form-control" />
						  			<form:errors path="shippingAddress.doorNumber" cssClass="text-danger" />
						  		</div>
						  		<div class="form-group">
						    		<label for="streetName"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.streetName" /> *</label>
						    		<form:input path="shippingAddress.streetName" size="25" id="streetName" type="text" class="form-control" />
						  			<form:errors path="shippingAddress.streetName" cssClass="text-danger" />
						  		</div>
						  		<div class="form-group">
						    		<label for=".areaName"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.areaName" /> *</label>
						    		<form:input path="shippingAddress.areaName" size="25" id="areaName" type="text" class="form-control" />
						  			<form:errors path="shippingAddress.areaName" cssClass="text-danger" />
						  		</div>
						  		<div class="form-group">
						    		<label for="state"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.state" /> *</label>
						    		<form:input path="shippingAddress.state" size="25" id="state" type="text" class="form-control" />
						  			<form:errors path="shippingAddress.state" cssClass="text-danger" />
						  		</div>
						  		<div class="form-group">
						    		<label for="country"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.country" /> *</label>
						    		<form:input path="shippingAddress.country" size="25" id="country" type="text" class="form-control" />
						  			<form:errors path="shippingAddress.country" cssClass="text-danger" />
						  		</div>
						  		<div class="form-group">
						    		<label for="zipCode"><spring:message code="sjp.showcases.ocs.webflow.shipping.form.zipCode" /> *</label>
						    		<form:input path="shippingAddress.zipCode" size="255" id="zipCode" type="text" class="form-control" />
						  		...
						  		<button class="btn btn-outline-danger" name="_eventId_webflow-back-to-customer-info">
						  			<spring:message code="sjp.showcases.ocs.webflow.shipping.form.back" />
						  		</button>
						  		<button type="submit" class="btn btn-outline-danger" name="_eventId_webflow-shipping-details-collected">
						  			<spring:message code="sjp.showcases.ocs.webflow.shipping.form.submit" />
						  		</button>
						  		<button class="btn btn-outline-danger" name="_eventId_cancel">
						  			<spring:message code="sjp.showcases.ocs.webflow.shipping.form.cancel" />
						  		</button>
							</form:form >
						</div>
					</div>
